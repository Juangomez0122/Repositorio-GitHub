...
<body>
    <div class="container-fluid ">
        <h1 class="text-center"><b>Registro de Hoteles</b></h1>
        <div class="container1 container-fluid">
            <form method="post" action="">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" id="no_estrellas" name="no_estrellas" min="1" max="5" placeholder="Ingresa las estrellas" autofocus required
                    pattern="[0-9]{10}" 
                    oninvalid="this.setCustomValidity('Solamente Números')"
                    oninput="this.setCustomValidity('')">
                </div>
                <div class="form-group mb-3">
                    <label for="telefono">Teléfono:</label>
                    <input type="tel" class="form-control" id="telefono" name="telefono" min="1" max="5" placeholder="Ingresa el teléfono" autofocus required
                    pattern="[0-9]{10}" 
